...
public class BotServiceUI {
    ...
    public void addFrame(Context context){
        ...
        mWinMgr.addView(mFrameLayout, params);

        LayoutInflater layoutInflater=(LayoutInflater)context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        layoutInflater.inflate(R.layout.frame_layout, mFrameLayout);
    ...
    public void hide() {
        if (mWinMgr != null) {
            ...
            if(mFrameLayout!=null){
                mWinMgr.removeView(mFrameLayout);
            }
        }
        mContext = null;
        mWinMgr = null;
